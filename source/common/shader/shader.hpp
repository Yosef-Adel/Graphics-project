...
namespace our {
    ...
    public:
        ...
        //In this case, it's legal for a static method of that class (or any other member) to call a private constructor of a class.
        //This doesn't hold for deleted constructors.
    };
